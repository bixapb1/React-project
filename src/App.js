...
import "./App.css";
import { ReactComponent as ReactLogo } from "../../react-project/src/logo.svg";
...
function App() {
  return (
    <>
      ...
      <Layout title="This is block one" urlBg={SunAndSea}>
        <p>
      ...
      <Layout title="This is block two" colorBg="lightgrey">
        <div className="flex">
          {POKEMONS.map((item) => {
            return (
              <PokemonCard
      ...
      <Layout title="This is block three" urlBg={Pokemon}>
        <p>
          In the game two players face off against one another, one side playing
          as "blue", the other as "red" on a 3x3 grid.
        </p>
